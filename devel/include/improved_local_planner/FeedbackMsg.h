// Generated by gencpp from file improved_local_planner/FeedbackMsg.msg
// DO NOT EDIT!


#ifndef IMPROVED_LOCAL_PLANNER_MESSAGE_FEEDBACKMSG_H
#define IMPROVED_LOCAL_PLANNER_MESSAGE_FEEDBACKMSG_H
...
#include <improved_local_planner/TrajectoryMsg.h>
...
struct FeedbackMsg_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::improved_local_planner::TrajectoryMsg_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::improved_local_planner::TrajectoryMsg_<ContainerAllocator> >::other >  _trajectories_type;
  ...
  typedef boost::shared_ptr< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> const> ConstPtr;

}; // struct FeedbackMsg_

typedef ::improved_local_planner::FeedbackMsg_<std::allocator<void> > FeedbackMsg;

typedef boost::shared_ptr< ::improved_local_planner::FeedbackMsg > FeedbackMsgPtr;
typedef boost::shared_ptr< ::improved_local_planner::FeedbackMsg const> FeedbackMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::improved_local_planner::FeedbackMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::improved_local_planner::FeedbackMsg_<ContainerAllocator1> & lhs, const ::improved_local_planner::FeedbackMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::improved_local_planner::FeedbackMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe8086148d3a39de2ULL;
  static const uint64_t static_value2 = 0x4ca2cc423f1e94e6ULL;
};

template<class ContainerAllocator>
struct DataType< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::improved_local_planner::FeedbackMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::improved_local_planner::FeedbackMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.trajectories.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::improved_local_planner::TrajectoryMsg_<ContainerAllocator> >::stream(s, indent + "    ", v.trajectories[i]);
    }
...
#endif // IMPROVED_LOCAL_PLANNER_MESSAGE_FEEDBACKMSG_H
